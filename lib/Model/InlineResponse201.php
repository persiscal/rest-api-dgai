...
class InlineResponse201 implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['codigo_acta'] = isset($data['codigo_acta']) ? $data['codigo_acta'] : null;
    }
     ...
     * @return int
     */
    public function getCodigoActa()
    {
        return $this->container['codigo_acta'];
    }

    /**
     * Sets codigo_acta
     *
     * @param int $codigo_acta codigo_acta
     *
     * @return $this
     */
    public function setCodigoActa($codigo_acta)
    {
        $this->container['codigo_acta'] = $codigo_acta;
